...
const T = {
  title: { TR: "Gizlilik Politikası", DE: "Datenschutzerklärung", EN: "Privacy Policy", KU: "Polîtîkaya Nihêniyê", CKB: "سیاسەتی تایبەتمەندی" },
  intro: {
    ...
    CKB: "ئێمە وەک VAM (Visit Anatolia and Mesopotamia) گرنگی زۆر بە ئاسایشی داتا کەسییەکانتان دەدەین. ئەم سیاسەتی تایبەتمەندییە ڕوون دەکاتەوە کە بۆ چ مەبەستێک داتا کەسییەکانی وەرگیراو لە ڕێگەی ماڵپەڕەکەمانەوە پرۆسێس دەکرێن، لەگەڵ کێ بڵاو دەکرێنەوە و مافەکانتان وەک خاوەنی داتا چین.",
  },
  s1_title: { TR: "1. Veri Sorumlusu", DE: "1. Verantwortlicher", EN: "1. Data Controller", KU: "1. Berpirsê Daneyan", CKB: "١. بەرپرسی داتا" },
  s1_body: {
    ...
    CKB: "ئەم پلاتفۆرمە، لەلایەن کارگێڕی تاکەکەسی نارین کالچیکەوە، لە ناونیشانی توشبا/وان، تورکیا بەڕێوە دەبردرێت. وەک بەرپرسی داتا، ئێمە داتا کەسییەکانتان بەپێی یاسای پاراستنی داتا کەسی ژمارە ٦٦٩٨ی تورکیا (\"KVKK\") و ڕێنمایی گشتی پاراستنی داتای یەکێتی ئەوروپا (\"GDPR\") پرۆسێس دەکەین.",
  },
  contact_label: { TR: "İletişim", DE: "Kontakt", EN: "Contact", KU: "Têkilî", CKB: "پەیوەندی" },
  s2_title: { TR: "2. Toplanan Kişisel Veriler", DE: "2. Erhobene personenbezogene Daten", EN: "2. Personal Data Collected", KU: "2. Daneyên Kesane yên tên Berhevkirin", CKB: "٢. داتا کەسییە کۆکراوەکان" },
  s2_intro: {
    ...
    CKB: "لە کاتی بەکارهێنانی ماڵپەڕ و خزمەتگوزارییەکانمان، ئەم داتایانە دەکرێت کۆبکرێنەوە:",
  },
  s2_li1: { TR: "Ad, soyad, e-posta adresi, telefon numarası", DE: "Vor- und Nachname, E-Mail-Adresse, Telefonnummer", EN: "First and last name, email address, phone number", KU: "Nav, paşnav, navnîşana e-peyamê, hejmara telefonê", CKB: "ناو، نازناو، ناونیشانی ئیمەیل، ژمارەی تەلەفۆن" },
  s2_li2: { TR: "Fatura/teslimat adresi bilgileri", DE: "Rechnungs-/Lieferadresse", EN: "Billing/delivery address information", KU: "Agahiyên navnîşana fatûre/radestkirinê", CKB: "زانیاری پسوڵە/ناونیشانی گەیاندن" },
  s2_li3: { TR: "Rezervasyon ve seyahat tercihleri (destinasyon, tarih, kişi sayısı)", DE: "Buchungs- und Reisepräferenzen (Reiseziel, Datum, Personenzahl)", EN: "Reservation and travel preferences (destination, date, number of people)", KU: "Vebijarkên rezervasyon û gerê (cîhê armanc, dîrok, hejmara kesan)", CKB: "ئارەزووەکانی ڕیزێرڤ و گەشت (شوێن، بەروار، ژمارەی کەس)" },
  s2_li4: { TR: "Ödeme işlemine ilişkin sınırlı veriler (kart bilgilerinin tamamı bizde saklanmaz, ödeme kuruluşu tarafından işlenir)", DE: "Begrenzte Zahlungsdaten (vollständige Kartendaten werden nicht bei uns gespeichert, sondern vom Zahlungsdienstleister verarbeitet)", EN: "Limited payment-related data (full card details are not stored by us and are processed by the payment provider)", KU: "Daneyên sînordar ên girêdayî dayînê (agahiyên qerta bi tevahî li ba me nayên tomarkirin, ji hêla kompaniya dayînê ve tên şixulandin)", CKB: "داتای سنووردار سەبارەت بە پارەدان (هەموو زانیارییەکانی کارت لای ئێمە هەڵنەگیراوە، لەلایەن کۆمپانیای پارەدانەوە پرۆسێس دەکرێت)" },
  s2_li5: { TR: "Site kullanım verileri (IP adresi, tarayıcı bilgisi, çerezler)", DE: "Nutzungsdaten der Website (IP-Adresse, Browserinformationen, Cookies)", EN: "Site usage data (IP address, browser information, cookies)", KU: "Daneyên bikaranîna malperê (navnîşana IP, agahiyên gerokê, çerez)", CKB: "داتای بەکارهێنانی ماڵپەڕ (ناونیشانی IP، زانیاری وێبگەڕ، کووکیز)" },
  s3_title: { TR: "3. Verilerin İşlenme Amaçları", DE: "3. Zwecke der Datenverarbeitung", EN: "3. Purposes of Processing", KU: "3. Armancên Şixulandina Daneyan", CKB: "٣. مەبەستەکانی پرۆسێسکردنی داتا" },
  s3_li1: { TR: "Rezervasyon ve paket satın alma işlemlerinin gerçekleştirilmesi", DE: "Abwicklung von Buchungen und Paketkäufen", EN: "Carrying out reservations and package purchases", KU: "Pêkanîna rezervasyon û kirrîna pakêtan", CKB: "جێبەجێکردنی ڕیزێرڤ و کڕینی پاکێج" },
  s3_li2: { TR: "Müşteri hizmetleri ve destek taleplerinin yanıtlanması", DE: "Beantwortung von Kundenservice- und Support-Anfragen", EN: "Responding to customer service and support requests", KU: "Bersivandina daxwazên karûbarê xerîdar û piştgiriyê", CKB: "وەڵامدانەوەی داواکارییەکانی خزمەتگوزاری خەرجدار و پشتگیری" },
  s3_li3: { TR: "Yasal yükümlülüklerin (fatura düzenleme, muhasebe kayıtları) yerine getirilmesi", DE: "Erfüllung gesetzlicher Pflichten (Rechnungsstellung, Buchhaltungsunterlagen)", EN: "Fulfilling legal obligations (invoicing, accounting records)", KU: "Bicihanîna berpirsiyariyên qanûnî (rêkirina fatûreyan, tomarên hesabdariyê)", CKB: "جێبەجێکردنی ئەرکە یاساییەکان (دەرکردنی پسووڵە، تۆمارە ژمێریاریەکان)" },
  s3_li4: { TR: "Hizmet kalitesinin artırılması ve site performansının analiz edilmesi", DE: "Verbesserung der Servicequalität und Analyse der Website-Performance", EN: "Improving service quality and analyzing site performance", KU: "Zêdekirina kalîteya karûbar û analîzkirina performansa malperê", CKB: "باشترکردنی کوالێتی خزمەتگوزاری و شیکردنەوەی کارایی ماڵپەڕ" },
  s3_li5: { TR: "Açık rızanız bulunması halinde pazarlama ve bilgilendirme iletişimleri", DE: "Marketing- und Informationsmitteilungen, sofern Sie ausdrücklich eingewilligt haben", EN: "Marketing and informational communications, where you have given explicit consent", KU: "Danûstandinên bazarî û agahdariyê, heke razîbûna we ya eşkere hebe", CKB: "پەیوەندی بازاڕکردن و ئاگادارکردنەوە، لە کاتی بوونی ڕەزامەندیی ئاشکرا" },
  s4_title: { TR: "4. Verilerin Paylaşıldığı Taraflar", DE: "4. Empfänger der Daten", EN: "4. Parties with Whom Data Is Shared", KU: "4. Alîyên ku Daneyan pê re tên Parvekirin", CKB: "٤. لایەنەکانی هاوبەشکراو لەگەڵیان داتاکان" },
  s4_intro: {
    ...
    CKB: "داتا کەسییەکانتان، بەقەدەر پێویستی پێشکەشکردنی خزمەتگوزاری، دەکرێت لەگەڵ ئەم لایەنانە هاوبەش بکرێن:",
  },
  s4_li1: { TR: "Ödeme işlemlerini gerçekleştiren ödeme kuruluşu (iyzico ve ilgili bankalar)", DE: "Der Zahlungsdienstleister, der die Zahlungen abwickelt (iyzico und beteiligte Banken)", EN: "The payment provider processing payments (iyzico and related banks)", KU: "Kompaniya dayînê ya ku danûstandinan pêk tîne (iyzico û bankên girêdayî)", CKB: "کۆمپانیای پارەدانی جێبەجێکەری پارەدانەکان (iyzico و بانکە پەیوەندیدارەکان)" },
  s4_li2: { TR: "Rezervasyonun gerçekleştirileceği yerel tur operatörleri, rehberler ve konaklama tesisleri", DE: "Lokale Reiseveranstalter, Guides und Unterkünfte, bei denen die Buchung durchgeführt wird", EN: "Local tour operators, guides, and accommodation facilities where the reservation is carried out", KU: "Operatorên gerê yên herêmî, rêber û taybetmendiyên kirêdayînê yên ku rezervasyon lê pêk tê", CKB: "ئۆپەراتۆرە گەشتیارییە هەرێمیەکان، ڕابەرەکان و تایبەتمەندییەکانی جێگە کە ڕیزێرڤ تێیدا جێبەجێ دەبێت" },
  s4_li3: { TR: "Yasal zorunluluk halinde yetkili kamu kurum ve kuruluşları", DE: "Zuständige Behörden im Falle einer gesetzlichen Verpflichtung", EN: "Authorized public institutions and organizations in case of legal obligation", KU: "Sazî û dezgehên gelemperî yên salahîyetdar di rewşa mecbûriyeta qanûnî de", CKB: "دەزگا و ڕێکخراوە فەرمییە دەسەڵاتدارەکان لە کاتی ئەرکی یاسایی" },
  s4_body2: {
    ...
    CKB: "داتاکانتان، جگە لەوانەی سەرەوە باسکراون، بۆ مەبەستی بازرگانی لەگەڵ لایەنی سێیەم هاوبەش ناکرێن یان ناهفرۆشرێن.",
  },
  s5_title: { TR: "5. Veri Saklama Süresi", DE: "5. Speicherdauer", EN: "5. Data Retention Period", KU: "5. Dema Tomarkirina Daneyan", CKB: "٥. ماوەی هەڵگرتنی داتا" },
  s5_body: {
    ...
    CKB: "داتا کەسییەکانتان، بۆ ماوەی پێویست بۆ مەبەستی پرۆسێسکردن و ئەرکە یاساییەکانی هەڵگرتن (بۆ نموونە، ٥ ساڵ بۆ بەڵگەنامەکانی لەژێر یاسای ڕێوشوێنی باج) هەڵدەگیرێن. لە کۆتایی ماوەکەدا، داتاکان دەسڕدرێنەوە، لەناودەبرێن یان بێناو دەکرێن.",
  },
  s6_title: { TR: "6. Çerezler (Cookies)", DE: "6. Cookies", EN: "6. Cookies", KU: "6. Çerez", CKB: "٦. کووکیز (Cookies)" },
  s6_body: {
    ...
    CKB: "ماڵپەڕەکەمان، بۆ باشترکردنی ئەزموونی بەکارهێنەر و شیکردنەوەی هاتووچۆی ماڵپەڕ، کووکیز بەکاردەهێنێت. دەتوانن لە ڕێکخستنەکانی وێبگەڕەکەتانەوە کووکیز لابەرن؛ بەڵام لەم حاڵەتەدا، هەندێک تایبەتمەندی ماڵپەڕ بە باشی کار نەکات.",
  },
  s7_title: { TR: "7. Veri Sahibinin Hakları", DE: "7. Rechte der betroffenen Person", EN: "7. Rights of the Data Subject", KU: "7. Mafên Xwediyê Daneyan", CKB: "٧. مافەکانی خاوەنی داتا" },
  s7_intro: {
    ...
    CKB: "بەپێی ماددەی ١١ی KVKK و ماددەی ١٥-٢٢ی GDPR، خاوەنی ئەم مافانەن:",
  },
  s7_li1: { TR: "Kişisel verilerinizin işlenip işlenmediğini öğrenme", DE: "Auskunft darüber, ob Ihre personenbezogenen Daten verarbeitet werden", EN: "To learn whether your personal data is being processed", KU: "Fêrbûna ka daneyên we yên kesane têne şixulandin an na", CKB: "زانینی ئەوەی داتا کەسییەکانتان پرۆسێس دەکرێن یان نا" },
  s7_li2: { TR: "İşlenen verilere ilişkin bilgi talep etme", DE: "Auskunft über die verarbeiteten Daten zu verlangen", EN: "To request information about processed data", KU: "Daxwaza agahî li ser daneyên ku têne şixulandin", CKB: "داواکردنی زانیاری سەبارەت بە داتا پرۆسێسکراوەکان" },
  s7_li3: { TR: "Verilerin düzeltilmesini veya silinmesini talep etme", DE: "Berichtigung oder Löschung der Daten zu verlangen", EN: "To request correction or deletion of data", KU: "Daxwaza rastkirin an jêbirina daneyan", CKB: "داواکردنی ڕاستکردنەوە یان سڕینەوەی داتا" },
  s7_li4: { TR: "İşlemeye itiraz etme ve rıza geri çekme", DE: "Widerspruch gegen die Verarbeitung einzulegen und die Einwilligung zu widerrufen", EN: "To object to processing and withdraw consent", KU: "Vegotina li dijî şixulandinê û paşvekişandina razîbûnê", CKB: "ڕەخنە لە پرۆسێسکردن و پاشگەزبوونەوە لە ڕەزامەندی" },
  s7_li5: { TR: "Verilerinizin başka bir veri sorumlusuna aktarılmasını talep etme (veri taşınabilirliği)", DE: "Die Übertragung Ihrer Daten an einen anderen Verantwortlichen zu verlangen (Datenübertragbarkeit)", EN: "To request the transfer of your data to another data controller (data portability)", KU: "Daxwaza veguhastina daneyên we li berpirsiyarekî din ê daneyan (guhezbariya daneyan)", CKB: "داواکردنی گواستنەوەی داتاکانتان بۆ بەرپرسێکی داتای دیکە (گواستراوەیی داتا)" },
  s7_footer_pre: {
    ...
    CKB: "بۆ بەکارهێنانی ئەم مافانە، دەتوانن لە ڕێگەی",
  },
  s7_footer_post: {
    ...
    CKB: "پەیوەندیمان پێوە بکەن.",
  },
  s8_title: { TR: "8. Veri Güvenliği", DE: "8. Datensicherheit", EN: "8. Data Security", KU: "8. Ewlehiya Daneyan", CKB: "٨. ئاسایشی داتا" },
  s8_body: {
    ...
    CKB: "بۆ دڵنیابوون لە ئاسایشی داتا کەسییەکانتان، ڕێوشوێنی گونجاوی تەکنیکی و کارگێڕی وەردەگیرێت. زانیاری پارەدانتان ڕاستەوخۆ لەلایەن ئێمەوە هەڵناگیرێت؛ لە ڕێگەی بنەمای تەکنەلۆژیای کۆمپانیای پارەدان کە بگونجێت لەگەڵ PCI-DSS پرۆسێس دەکرێت.",
  },
  s9_title: { TR: "9. Politika Değişiklikleri", DE: "9. Änderungen der Richtlinie", EN: "9. Policy Changes", KU: "9. Guherînên Polîtîkayê", CKB: "٩. گۆڕانکارییەکانی سیاسەت" },
  s9_body: {
    ...
    CKB: "ئەم سیاسەتی تایبەتمەندییە لەوانەیە کات بە کات نوێ بکرێتەوە. وەشانی ڕۆژانە هەمیشە لەم پەڕەیە بڵاو دەکرێتەوە.",
  },
} as const;
...
export async function generateMetadata() {
  ...
  return {
    ...
    alternates: { canonical: canonicalForLang("/gizlilik-politikasi", urlLang), languages: buildAlternates("/gizlilik-politikasi") },
  };
}
