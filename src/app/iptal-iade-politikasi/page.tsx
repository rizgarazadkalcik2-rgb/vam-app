...
const T = {
  title: { TR: "İptal ve İade Politikası", DE: "Stornierungsrichtlinie", EN: "Cancellation and Refund Policy", KU: "Polîtîkaya Betalkirin û Vegerandinê" },
  intro: {
  ...
  s1_title: { TR: "1. Genel İptal Süreleri", DE: "1. Allgemeine Stornierungsfristen", EN: "1. General Cancellation Periods", KU: "1. Dema Betalkirinê ya Giştî" },
  s1_body1_pre: {
  ...
  s1_body1_strong: { TR: "en az 7 gün önce", DE: "mindestens 7 Tage vor dem Buchungstermin", EN: "at least 7 days before the reservation date", KU: "herî kêm 7 roj berî dîroka rezervasyonê" },
  s1_body1_post: {
  ...
  s1_body2_strong: { TR: "Önemli:", DE: "Wichtig:", EN: "Important:", KU: "Girîng:" },
  s1_body2: {
  ...
  s2_title: { TR: "2. Geç İptal ve Katılmama (No-Show) Durumu", DE: "2. Verspätete Stornierung und Nichterscheinen (No-Show)", EN: "2. Late Cancellation and No-Show", KU: "2. Betalkirina Dereng û Ne-hatina (No-Show)" },
  s2_body_pre: {
  ...
  s2_body_strong: { TR: "ödenen tutar iade edilmez", DE: "der gezahlte Betrag nicht erstattet", EN: "the amount paid is not refunded", KU: "mîqdara ku hatiye dayîn nayê vegerandin" },
  s2_body_post: {
  ...
  s3_title: { TR: "3. İptal Talebi Nasıl Yapılır", DE: "3. So stellen Sie eine Stornierungsanfrage", EN: "3. How to Submit a Cancellation Request", KU: "3. Daxwaza Betalkirinê Çawa tê Kirin" },
  s3_intro: {
  ...
  s3_email_label: { TR: "E-posta", DE: "E-Mail", EN: "Email", KU: "E-peyam" },
  s3_phone_label: { TR: "Telefon", DE: "Telefon", EN: "Phone", KU: "Telefon" },
  s3_body2: {
  ...
  s4_title: { TR: "4. İade Süreci", DE: "4. Rückerstattungsprozess", EN: "4. Refund Process", KU: "4. Pêvajoya Vegerandinê" },
  s4_body_pre: {
  ...
  s4_body_strong: { TR: "7-14 iş günü", DE: "7-14 Werktagen", EN: "7-14 business days", KU: "7-14 rojên xebatê" },
  s4_body_post: {
  ...
  s5_title: { TR: "5. VAM Tarafından İptal Edilen Turlar", DE: "5. Von VAM stornierte Touren", EN: "5. Tours Cancelled by VAM", KU: "5. Geştên ku VAM Betal Dike" },
  s5_body: {
  ...
  s6_title: { TR: "6. Değişiklik Talepleri", DE: "6. Änderungsanfragen", EN: "6. Change Requests", KU: "6. Daxwazên Guherînê" },
  s6_body: {
  ...
  s7_title: { TR: "7. Mesafeli Sözleşmeler Yönetmeliği Kapsamındaki Haklarınız", DE: "7. Ihre Rechte gemäß der Verordnung über Fernabsatzverträge", EN: "7. Your Rights Under the Distance Contracts Regulation", KU: "7. Mafên we di bin Rêziknameya Peymanên Firotina ji Dûr ve" },
  s7_body_pre: {
  ...
  s7_link: { TR: "Mesafeli Satış Sözleşmesi", DE: "Fernabsatzvertrag", EN: "Distance Sales Agreement", KU: "rûpela Peymana Firotina ji Dûr ve" },
  s7_body_post: {
