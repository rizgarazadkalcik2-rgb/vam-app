...
const T = {
  ...
  intro_pre: {
    ...
    CKB: "بەرهەمە کڕدراوەکان لە ڕێگەی VAM (Visit Anatolia and Mesopotamia)ەوە، کاڵای گەیەنراو بە کارگۆ نین، بەڵکو",
  },
  intro_strong: { TR: "seyahat ve deneyim hizmetleridir", DE: "Reise- und Erlebnisdienstleistungen, die zu einem bestimmten Termin erbracht werden", EN: "travel and experience services performed on a specific date", KU: "karûbarên gerê û ezmûnê ne ku di rojeke diyarkirî de têne pêkanîn", CKB: "خزمەتگوزاریی گەشت و ئەزموون کە لە بەرواریەکی دیاریکراودا جێبەجێ دەکرێن" },
  intro_post: {
    ...
    CKB: "ئەم پەڕەیە، مەرجەکانی سەبارەت بە چۆنیەتی و کاتی پێشکەشکردنی خزمەتگوزارییەکە ڕوون دەکاتەوە.",
  },
  s1_title: { TR: "1. Rezervasyon Onayı", DE: "1. Buchungsbestätigung", EN: "1. Reservation Confirmation", KU: "1. Piştrastkirina Rezervasyonê", CKB: "١. پشتڕاستکردنەوەی ڕیزێرڤ" },
  s1_body: {
    ...
    CKB: "دوای تەواوبوونی سەرکەوتووی پارەدان، وردەکارییەکانی ڕیزێرڤتان (بەروار، ناوەڕۆکی پاکێج، ژمارەی بەشداربووان، زانیاری پەیوەندی) بۆ ناونیشانی ئیمەیلی تۆمارکراوتان دەنێردرێت. ئەم ئیمەیلە، وەک پشتڕاستکردنەوەی فەرمیی ڕیزێرڤتان دادەنرێت.",
  },
  s2_title: { TR: "2. Hizmetin Sunum Şekli", DE: "2. Art der Leistungserbringung", EN: "2. How the Service Is Provided", KU: "2. Awayê Pêşkêşkirina Karûbarê", CKB: "٢. شێوازی پێشکەشکردنی خزمەتگوزاری" },
  s2_intro: {
    ...
    CKB: "بەپێی پاکێجی کڕدراوتان، خزمەتگوزارییەکە دەکرێت ئەم بەشانە لەخۆبگرێت:",
  },
  s2_li1: { TR: "Rehberli tur ve gezi programı", DE: "Geführte Tour und Reiseprogramm", EN: "Guided tour and itinerary", KU: "Geşta rêberkirî û bernameya gerê", CKB: "گەشتی ڕابەرایەتیکراو و بەرنامەی گەڕان" },
  s2_li2: { TR: "Konaklama rezervasyonu (anlaşmalı tesisler aracılığıyla)", DE: "Unterkunftsbuchung (über Partnerbetriebe)", EN: "Accommodation reservation (through partner facilities)", KU: "Rezervasyona kirêdayînê (bi rêya taybetmendiyên li hev kirî)", CKB: "ڕیزێرڤی جێگە (لە ڕێگەی تایبەتمەندییە ڕێکەوتووەکانەوە)" },
  s2_li3: { TR: "Yerel ulaşım organizasyonu", DE: "Organisation des lokalen Transports", EN: "Local transport organization", KU: "Rêxistina veguhastina herêmî", CKB: "ڕێکخستنی گواستنەوەی ناوخۆیی" },
  s2_li4: { TR: "Giriş ücretleri ve özel deneyimler (pakette belirtilmişse)", DE: "Eintrittsgebühren und besondere Erlebnisse (sofern im Paket angegeben)", EN: "Entrance fees and special experiences (if specified in the package)", KU: "Bacên têketinê û ezmûnên taybet (heke di pakêtê de hatibe diyarkirin)", CKB: "کرێی چوونەژوورەوە و ئەزموونی تایبەت (ئەگەر لە پاکێجەکەدا دیاری کرابێت)" },
  s2_body2: {
    ...
    CKB: "بەرفراوانیی تەواوی هەر پاکێجێک، بە وردی لە پەڕەی پاکێجی پەیوەندیدار دیاری دەکرێت.",
  },
  s3_title: { TR: "3. Hizmet Tarihi ve Süresi", DE: "3. Leistungsdatum und -dauer", EN: "3. Service Date and Duration", KU: "3. Dîrok û Dema Karûbarê", CKB: "٣. بەروار و ماوەی خزمەتگوزاری" },
  s3_body_pre: {
    ...
    CKB: "بەرواری کە خزمەتگوزارییەکە تێیدا جێبەجێ دەبێت، ئەو بەروارەیە کە لە کاتی ڕیزێرڤدا هەڵبژێردراوە یان لە ئیمەیلی پشتڕاستکردنەوەدا دیاری کراوە. داواکارییەکانی گۆڕینی بەروار، لەژێر مەرجەکانی پەڕەی",
  },
  s3_link: { TR: "İptal ve İade Politikası", DE: "Stornierungsrichtlinie", EN: "Cancellation and Refund Policy", KU: "rûpela Polîtîkaya Betalkirin û Vegerandinê", CKB: "سیاسەتی هەڵوەشاندنەوە و گەڕاندنەوەی پارە" },
  s3_body_post: {
  ...
  s4_title: { TR: "4. Belge ve Bilgilendirme Teslimi", DE: "4. Zustellung von Dokumenten und Informationen", EN: "4. Delivery of Documents and Information", KU: "4. Radestkirina Belge û Agahiyan", CKB: "٤. گەیاندنی بەڵگەنامە و زانیاری" },
  s4_body: {
    ...
    CKB: "بەڵگەنامەکانی وەک vaucher، وردەکارییەکانی بەرنامە، خاڵی کۆبوونەوە و زانیاری پەیوەندیی ڕابەر، پێش بەرواری خزمەتگوزاری بە شێوەی ئەلیکترۆنی لە ڕێگەی ئیمەیلەوە دەنێردرێن. لەبەر ئەوە گرنگە کە ناونیشانی ئیمەیلی دراوتان لە کاتی ڕیزێرڤدا، ڕاست و گەیشتوو بێت.",
  },
  s5_title: { TR: "5. Katılımcı Yükümlülükleri", DE: "5. Pflichten der Teilnehmer", EN: "5. Participant Obligations", KU: "5. Berpirsiyariyên Beşdaran", CKB: "٥. ئەرکەکانی بەشداربووان" },
  s5_intro: {
    ...
    CKB: "بۆ جێبەجێبوونی بێکێشەی خزمەتگوزارییەکە، پێویستە بەشداربووان سەرنج بدەنە ئەم خاڵانە:",
  },
  s5_li1: { TR: "Buluşma noktasına belirtilen saatte hazır bulunmak", DE: "Pünktliches Erscheinen am Treffpunkt zur angegebenen Zeit", EN: "Being present at the meeting point at the specified time", KU: "Li xala civînê di demjimêra diyarkirî de amade bûn", CKB: "لە کاتی دیاریکراودا لە خاڵی کۆبوونەوە ئامادە بوون" },
  s5_li2: { TR: "Geçerli kimlik/pasaport belgesini yanında bulundurmak", DE: "Mitführen eines gültigen Ausweis-/Reisepassdokuments", EN: "Carrying a valid ID/passport document", KU: "Anîna belgeya nasnameyê/pasaporta derbasdar", CKB: "هەڵگرتنی بەڵگەنامەی ناسنامە/پاسپۆرتی دروست لەگەڵ خۆیان" },
  s5_li3: { TR: "Sağlık durumu, hareket kısıtlılığı veya özel ihtiyaçların rezervasyon öncesinde bildirilmesi", DE: "Mitteilung von Gesundheitszustand, Mobilitätseinschränkungen oder besonderen Bedürfnissen vor der Buchung", EN: "Informing us of any health conditions, mobility limitations, or special needs before the reservation", KU: "Ragihandina rewşa tenduristiyê, sînordariya tevgerê an hewcedariyên taybet berî rezervasyonê", CKB: "ڕاگەیاندنی بارودۆخی تەندروستی، سنووردارییەکانی جووڵە یان پێداویستییە تایبەتەکان پێش ڕیزێرڤ" },
  s6_title: { TR: "6. Hizmetin Sağlanamaması", DE: "6. Nichterbringung der Leistung", EN: "6. Inability to Provide the Service", KU: "6. Nekarîna Peydakirina Karûbarê", CKB: "٦. نەتوانینی پێشکەشکردنی خزمەتگوزاری" },
  s6_body: {
    ...
    CKB: "ئەگەر بەهۆی هۆکاری زۆرەملێ، بارودۆخی کەشوهەوا، هۆکاری ئاسایش یان بڕیاری دەسەڵاتدارە هەرێمییەکان خزمەتگوزارییەکە نەتوانرێت وەک پلاندانراو پێشکەش بکرێت، کڕیار بە زووترین کات ئاگادار دەکرێتەوە و بەرواری بەدیل، بەرنامەی بەدیل یان هەڵبژاردنی گەڕاندنەوەی پارە پێشکەش دەکرێت.",
  },
  s7_title: { TR: "7. Üçüncü Taraf Hizmet Sağlayıcılar", DE: "7. Drittanbieter", EN: "7. Third-Party Service Providers", KU: "7. Peydakerên Karûbarê yên Aliyê Sêyem", CKB: "٧. پێشکەشکارانی خزمەتگوزاریی لایەنی سێیەم" },
  s7_body: {
    ...
    CKB: "جێگە، گواستنەوە و هەندێک ئەزموونی دیاریکراو، دەکرێت لەلایەن پێشکەشکارانی خزمەتگوزاریی هەرێمیی ڕێکەوتووەوە پێشکەش بکرێن. مەرج و سیاسەتی تایبەت بەم پێشکەشکارانەیش دەکرێت جێبەجێ بێت؛ لەم حاڵەتانەدا زانیاریی پەیوەندیدار لە پەڕەی پاکێج یان لە پشتڕاستکردنەوەی ڕیزێرڤدا دیاری دەکرێت.",
  },
  s8_title: { TR: "8. İletişim", DE: "8. Kontakt", EN: "8. Contact", KU: "8. Têkilî", CKB: "٨. پەیوەندی" },
  s8_body_pre: {
    ...
    CKB: "بۆ پرسیارەکانتان سەبارەت بە پرۆسەی خزمەتگوزاری:",
  },
} as const;
